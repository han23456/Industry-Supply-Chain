...
(function () {
  ...
  const industries = ['机器人', '新能源汽车', '生物医药', '人工智能', '半导体', '绿色低碳', '工业互联网', '先进材料'];

  const heatmapData = [
    [{ count: 85, amount: 1250, health: 106, services: 12, active: 10, status: 'strong' }, { count: 62, amount: 890, health: 95, services: 8, active: 7, status: 'strong' }, { count: 55, amount: 820, health: 88, services: 7, active: 6, status: 'strong' }, { count: 28, amount: 420, health: 35, services: 2, active: 1, status: 'weak' }, { count: 92, amount: 1380, health: 115, services: 15, active: 14, status: 'strong' }, { count: 38, amount: 580, health: 65, services: 5, active: 3, status: 'normal' }, { count: 45, amount: 680, health: 78, services: 6, active: 4, status: 'normal' }, { count: 42, amount: 620, health: 70, services: 6, active: 4, status: 'normal' }],
    [{ count: 95, amount: 1420, health: 120, services: 16, active: 15, status: 'strong' }, { count: 72, amount: 980, health: 96, services: 10, active: 9, status: 'strong' }, { count: 48, amount: 720, health: 82, services: 7, active: 6, status: 'strong' }, { count: 35, amount: 520, health: 45, services: 3, active: 2, status: 'normal' }, { count: 32, amount: 480, health: 55, services: 4, active: 2, status: 'normal' }, { count: 28, amount: 420, health: 38, services: 2, active: 1, status: 'weak' }, { count: 58, amount: 870, health: 92, services: 8, active: 7, status: 'strong' }, { count: 45, amount: 650, health: 72, services: 6, active: 4, status: 'normal' }],
    [{ count: 52, amount: 780, health: 85, services: 7, active: 6, status: 'strong' }, { count: 78, amount: 1120, health: 98, services: 11, active: 10, status: 'strong' }, { count: 82, amount: 1220, health: 105, services: 12, active: 11, status: 'strong' }, { count: 22, amount: 320, health: 22, services: 0, active: 0, status: 'missing' }, { count: 38, amount: 580, health: 68, services: 5, active: 3, status: 'normal' }, { count: 45, amount: 680, health: 75, services: 6, active: 4, status: 'normal' }, { count: 65, amount: 970, health: 95, services: 9, active: 8, status: 'strong' }, { count: 28, amount: 420, health: 42, services: 3, active: 1, status: 'weak' }],
    [{ count: 58, amount: 880, health: 92, services: 8, active: 7, status: 'strong' }, { count: 55, amount: 820, health: 82, services: 7, active: 6, status: 'strong' }, { count: 35, amount: 520, health: 55, services: 4, active: 2, status: 'weak' }, { count: 42, amount: 620, health: 65, services: 5, active: 3, status: 'normal' }, { count: 45, amount: 680, health: 72, services: 6, active: 4, status: 'normal' }, { count: 32, amount: 480, health: 48, services: 4, active: 2, status: 'weak' }, { count: 68, amount: 980, health: 98, services: 9, active: 8, status: 'strong' }, { count: 25, amount: 380, health: 35, services: 2, active: 1, status: 'weak' }],
    [{ count: 32, amount: 480, health: 55, services: 4, active: 2, status: 'weak' }, { count: 35, amount: 520, health: 52, services: 4, active: 2, status: 'weak' }, { count: 28, amount: 420, health: 48, services: 3, active: 2, status: 'weak' }, { count: 18, amount: 280, health: 28, services: 1, active: 0, status: 'weak' }, { count: 22, amount: 320, health: 38, services: 2, active: 1, status: 'weak' }, { count: 28, amount: 420, health: 42, services: 3, active: 2, status: 'weak' }, { count: 42, amount: 620, health: 65, services: 5, active: 3, status: 'normal' }, { count: 38, amount: 580, health: 62, services: 5, active: 3, status: 'normal' }],
    [{ count: 55, amount: 820, health: 85, services: 7, active: 6, status: 'strong' }, { count: 82, amount: 1220, health: 110, services: 12, active: 11, status: 'strong' }, { count: 72, amount: 1080, health: 98, services: 10, active: 9, status: 'strong' }, { count: 25, amount: 380, health: 32, services: 2, active: 1, status: 'weak' }, { count: 38, amount: 580, health: 68, services: 5, active: 3, status: 'normal' }, { count: 55, amount: 820, health: 88, services: 7, active: 6, status: 'strong' }, { count: 48, amount: 720, health: 78, services: 6, active: 5, status: 'normal' }, { count: 35, amount: 520, health: 58, services: 4, active: 2, status: 'weak' }]
  ];
